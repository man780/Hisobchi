...
<form action="tamplate.php" method="POST" id="send-msg-form" style="width:200px; border:1px solid #ccc; text-align:center"><br />
	...
	<textarea style="width:180px" name="msgbody">Xabar kiriting</textarea><br />
	<input type="submit" class="btn" value="Xabar yubormoq" />
    <img id="load-indicator" src="img/loading.gif"/>
</form>
</div>
<script src="js/jquery-1.5.2.min.js" type="text/javascript"></script>
<script src="js/lesson2.js" type="text/javascript"></script>
